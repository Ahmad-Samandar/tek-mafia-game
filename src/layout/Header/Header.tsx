                  ...
                  <div className="d-flex order-lg-2">
                    ...
                    <Dropdown className="header-message d-flex">
                      ...
                      <Dropdown.Menu className=" dropdown-menu-end dropdown-menu-arrow  animated ps ps--active-y">
                        <PerfectScrollbar style={{ width: 325, height: 350 }}>
                          <div className="dropdown-header ">
                            <h6 className="mb-0">Messages</h6>
                            <span className="badge fs-10 bg-secondary br-7 ms-auto">New</span>
                          </div>
                          <Link className="dropdown-item border-bottom" to="#"><div className="d-flex align-items-center">
                            <div>
                              <span
                          ...
                          <Link className="dropdown-item border-bottom" to="#">
                    ...
                    <Dropdown className="header-notify d-flex">
                      ...
                      <Dropdown.Menu className=" dropdown-menu-end dropdown-menu-arrow  animated">
                        ...
                        <Link className="dropdown-item border-bottom d-flex ps-4" to="#">
                          <div
                        ...
                        <Link className="dropdown-item border-bottom d-flex ps-4 mb-2" to="#">
                          <div
                    ...
                    <Dropdown className="profile-dropdown d-flex">
                      ...
                      <Dropdown.Menu className=" dropdown-menu-end dropdown-menu-arrow animated">
                        ...
                        <Link className="dropdown-item d-flex" to="#"><svg className="header-icon me-2" xmlns="http://www.w3.org/2000/svg"
